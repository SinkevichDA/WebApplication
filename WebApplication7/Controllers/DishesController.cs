...
namespace WebApplication7.Controllers
{
    public class DishesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Dishes.Include(d => d.Group);
        ...
        public async Task<IActionResult> Create([Bind("DishId,DishName,Description,Calories,Image,DishGroupId")] Dish dish)
        {
            ...
            ViewData["DishGroupId"] = new SelectList(_context.DishGroups, "DishGroupId", "DishGroupId", dish.DishGroupId);
            return View(dish);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DishId,DishName,Description,Calories,Image,DishGroupId")] Dish dish)
        {
            if (id != dish.DishId)
            {
                return NotFound();
